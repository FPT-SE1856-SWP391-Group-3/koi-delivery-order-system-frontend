...
function CreateOrderInter() {
    ...
    const handleSubmitClick = useCallback(() => {
        ...
        formData.append(
            "StartAddress",
            senderInfo.startAddress || "Default address"
        )
        ...
        formData.append(
            ...
            receiverInfo.addressLine || ""
        )
        formData.append(
            "ReceiverFullAddressLine",
            `${receiverInfo.city}, ${receiverInfo.district}, ${receiverInfo.ward}, ${receiverInfo.address}`
        )
        ...
        <UserSideNav>
            ...
            <div className="main-content">
                ...
                <div className="form-sections">
                    ...
                    <OrderSummary
                        onChange={(notes) => setAdditionalNotes(notes)}
                    />
                </div>
