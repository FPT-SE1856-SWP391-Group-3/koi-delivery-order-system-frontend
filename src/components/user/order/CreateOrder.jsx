...
export default function CreateOrder() {
  ...
  useEffect(() => {
    ...
    api.get("ShippingMethods").then((data) => {
      if (data.success) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        <div>
          <label htmlFor="ShippingMethod">Phuong thuc van chuyen</label>
          <select {...register("shippingMethodId")}>
            {shippingMethods.map((shippingMethod) => (
              <option key={shippingMethod.shippingMethodId} value={shippingMethod.shippingMethodId}>
