...
export default function EditFeedback() {
    ...
    useEffect(() => {
        try {
            api.get('CustomerFeedbacks/' + customerFeedbackId)
              .then((data) => {
                if (data.success) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            api.put("CustomerFeedbacks/" + customerFeedbackId, feedbacks)
                .then(data => {
                    if (data.success) {
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setFeedbacks({ ...feedbacks, comment: e.target.value })}
                  />
                </div>
