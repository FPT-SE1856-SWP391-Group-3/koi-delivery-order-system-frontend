      ...
      <div className="sidebar-container">
        ...
        {(user.roleId === 5 || user.roleId === 3 || user.roleId === 4) && (
          <>
            {user.roleId === 5 && (
              <>
                <a href={ComponentPath.user.profile.viewProfile}>
                  View Profile
                </a>
                ...
                <a href={ComponentPath.admin.payment.managePaymentType}>
                  Manage Payment Type
                </a>
                ...
                <a href={ComponentPath.admin.blogNews.manageBlogNews}>
                  Manage Blog News
                </a>
                <a href={ComponentPath.admin.certification.manageCertification}>
                  Manage Certification
                </a>
                <a
                  href={ComponentPath.admin.order.document.manageOrderDocument}
                >
                  Manage Document
                </a>
              </>
