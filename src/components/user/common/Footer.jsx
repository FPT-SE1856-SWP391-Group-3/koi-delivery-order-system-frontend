        ...
        <div className="footer" id="footer">
            <div className="footer-content">
                <div className="footer-content-left">
                    <img
                        src={LOGO}
                        alt="Koi Delivery Logo"
                        className="footer-logo"
                    />
                    <h2>KOI Delivery</h2>
                    <p>
                        At KOI Delivery, we specialize in the safe and efficient
                        transportation of koi fish, ensuring the highest
                        standards of care throughout their journey. We deliver
                        your prized koi with utmost care and expertise.
                    </p>
