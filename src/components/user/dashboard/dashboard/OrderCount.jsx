...
export default function OrderCount() {
    ...
    const statuses = [
        ...
        {
            id: 4,
            label: "Đang lấy hàng, xử lí thủ tục hải quan (Nếu có)",
            color: "rgb(75, 192, 192)",
        },
        {
            id: 5,
            label: "Đã lấy hàng, đang kiểm tra sức khỏe",
            color: "rgb(153, 102, 255)",
        },
        {
            id: 6,
            label: "Đang đóng gói, chuẩn bị giấy chứng nhận",
            color: "rgb(255, 159, 64)",
        },
        {
            id: 7,
            label: "Đã đóng gói, chuẩn bị vận chuyển",
                ...
                <TableBody>
                    {statuses.map((status) => (
                        <TableRow key={status.id}>
                            ...
                            <TableCell>
                                {orderByStatus(status.id)} đơn hàng
                            </TableCell>
