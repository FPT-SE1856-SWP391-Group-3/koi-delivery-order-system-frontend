...
export default function BarChart() {
    ...
    const data = {
        ...
        datasets: [{
            ...
            data: [
                orderByStatus(1), orderByStatus(2), orderByStatus(3), orderByStatus(4),
                orderByStatus(5), orderByStatus(6), orderByStatus(7), orderByStatus(8),
                orderByStatus(9), orderByStatus(10), orderByStatus(11)
            ],
            backgroundColor: [
                'rgb(255, 99, 132)',
                'rgb(54, 162, 235)',
