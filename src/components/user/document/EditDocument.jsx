...
export default function EditDocument() {
    ...
    const handleSubmit = async (e) => {
        ...
        documentData.set('customerDocumentFile', customerDocument.customerDocumentFile);
        documentData.set('description', customerDocument.description);
        try {
            api.putForm("CustomerDocuments/" + documentId, documentData).then((data) => {
                if (data.success) {
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name="documentFile"
                                    onChange={(e) =>
                                        setCustomerDocument({ ...document, documentFile: e.target.files[0] })
                                    }
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    onChange={(e) =>
                                        setCustomerDocument({ ...document, description: e.target.value })
                                    }
                                />
                            </div>
