  ...
  const onSubmit = async (data) => {
    try {
      ...
      data.customerDocuments.forEach((customerDocument, index) => {
        ...
        customerData.append("customerDocumentFile", customerDocument.customerDocumentFile[0]);
          ...
          <div className="col-md-6 offset-md-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              {fields.map((field, index) => (
                <>
                  <div className="form-group">
                    <label htmlFor={`customerDocuments.${index}.orderId`}>Mã đơn hàng</label>
                    <input
                      type="number"
                      className="form-control"
                  ...
                  <div className="form-group">
                    <label htmlFor={`customerDocuments.${index}.userId`}>Mã người dùng</label>
                    <input
                      type="number"
                      className="form-control"
                  ...
                  <div className="form-group">
                    <input
                      ...
                      {...register(`customerDocuments.${index}.customerDocumentFile`)}
                    />
                  </div>
                  <div className="form-group">
