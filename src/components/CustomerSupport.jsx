  ...
  return (
    <>
      ...
      <div className="customersupport-container">
        ...
        <p>
          With the desire to diversify information access channels for customers
          as well as respond to the fastest consultation and answer customer
          questions. During the process of using products and services, you can
          send Requests/Feedback about products and services provided by KOI
          DELIVERY through the following channels. All your Requests/Feedback
          will be recorded and forwarded to the relevant departments for
          checking and processing. Update the channels you can contact for
          support immediately. fastest way:
        </p>
        <ul>
