...
useEffect(() => {
    try {
        api.get("OrderServiceDetails/" + id)
            .then((data) => {
                if (data.success) {
                    setValue("orderServiceDetailName", data.orderServiceDetail.orderServiceDetailName);
                    setValue("orderServiceDetailPrice", data.orderServiceDetail.orderServiceDetailPrice);
