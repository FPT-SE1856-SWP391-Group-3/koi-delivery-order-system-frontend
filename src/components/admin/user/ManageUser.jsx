  ...
  return (
    <>
      ...
      <Box sx={{ ml: "260px", p: 3 }}>
                ...
                filteredUsers
                  ...
                  .map((user) => (
                    <CollapsibleRow
                      key={user.userId}
                      user={user}
                      onEdit={() => openUpdateModal(user.userId)}
                      onDelete={() => openConfirmDeleteModal(user.userId)}
        ...
        <Modal open={isConfirmDeleteOpen} onClose={closeConfirmDeleteModal}>
          <Box
            sx={{
              position: "absolute",
              top: "50%",
      ...
      <TableRow>
        ...
        <TableCell align="right">
          ...
          <Menu
            ...
            open={
              Boolean(menuState.anchorEl) && menuState.userId === user.userId
            }
          ...
          >
            ...
            <MenuItem onClick={onDelete}>
              <DeleteIcon fontSize="small" sx={{ color: "#FF5630" }} /> Delete
            </MenuItem>
          </Menu>
        </TableCell>
      </TableRow>
