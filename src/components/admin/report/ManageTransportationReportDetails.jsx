                                ...
                                <tbody>
                                    {reports.map(report => (
                                        <tr key={report.transReportDetailId}>
                                            ...
                                            <td>
                                                <button className="btn btn-danger" onClick={() => deleteReport(report.transReportDetailId)}>Xóa</button>
                                                <Link to={{ pathname: `/admin/edit-transportation-report/${report.transReportDetailId}`, state: report }}>Sửa </Link>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
