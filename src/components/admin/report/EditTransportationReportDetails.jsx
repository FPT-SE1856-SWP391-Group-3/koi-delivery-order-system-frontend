...
export default function EditTransportationReportDetails() {
    const [updateReport, setUpdateReport] = useState({ issueTypeId: '', description: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            api.put("TransportationReportDetails/" + reportId, updateReport).then((data) => {
                if (data.success) {
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setUpdateReport({ ...updateReport, issueTypeId: e.target.value })} // Xử lý sự kiện thay đổi
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => setUpdateReport({ ...updateReport, description: e.target.value })}
                                />
                            </div>
